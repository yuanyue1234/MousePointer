...
const translations = {
  zh: {
    ...
    iconLabel: "软件图标",
    iconTitle: "鼠标指针配置管理器",
    iconText: "图标与程序本体保持一致，下载页、网页展示和程序入口统一识别。",
    downloadNow: "立即下载",
    ...
    f2Title: "多格式导入",
    f2Text: "支持 `.cur`、`.ani`、图片、`.zip`、`.rar`、`.7z`、`.exe` 和文件夹。",
    f3Title: "动态预览",
    f3Text: "静态与动态鼠标指针都能直接查看，便于在应用前确认细节。",
    f4Title: "大小辅助",
    f4Text: "用 `- / +` 与分段进度条查看方案适配范围，减少误触和试错。",
    f5Title: "截图导出",
    f5Text: "可导出方案预览图，动态指针保存为 GIF，便于分享和留档。",
    f6Title: "后台常驻",
    f6Text: "支持自启动后台、托盘保留、隐藏任务栏与启动修复。",
    refEyebrow: "参考",
    refTitle: "实现与灵感来源。",
    r1: "GitHub 项目仓库",
    r2: "InputTip 中英文切换思路",
  ...
  en: {
    ...
    iconText: "The icon stays consistent across the app, the download page, the website, and the launcher entry.",
    ...
    f2Title: "Multi-format Import",
    f2Text: "Supports `.cur`, `.ani`, images, `.zip`, `.rar`, `.7z`, `.exe`, and folders.",
    f3Title: "Animated Preview",
    f3Text: "Check static and animated cursor assets directly before applying them.",
    f4Title: "Size Helper",
    f4Text: "Use `- / +` and segmented steps to inspect fit range with less accidental input.",
    f5Title: "Screenshot Export",
    f5Text: "Export preview images, and keep animation frames in GIF format when needed.",
    f6Title: "Background Mode",
    f6Text: "Supports startup in background, tray persistence, taskbar hiding, and startup repair.",
